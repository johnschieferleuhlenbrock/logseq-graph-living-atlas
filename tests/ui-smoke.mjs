...
try {
  ...
  await page.waitForFunction(() => Number(document.querySelector(".atlas-canvas")?.getAttribute("data-nebula-tethers") || 0) > 5000, null, { timeout: 5000 });
  ...
  assert.ok(atlasMotionContract.tetherVertices > 5000, "nebula projections should expose dense visible node-backed tethers");
